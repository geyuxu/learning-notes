...
description: 'Windows 11 下两种 CUDA 开发环境配置（wsl & 本地工具链）'
pubDate: '2025/05/06'
---
...
* powershell中运行`nvcc .\hello.cu -o hello`进行编译
  ...
  ![image-20250506233805553](https://img.geyuxu.com/image-20250506233805553.png)

* 执行hello.exe程序

  ![image-20250506233944058](https://img.geyuxu.com/image-20250506233944058.png)
...
2. **验证 CUDA 安装：** 安装完成后，运行 nvcc --version 检查 CUDA 是否安装成功。如果返回 CUDA 编译器的版本信息，说明 CUDA 已正确安装。
   ...
   ![image-20250506234103468](https://img.geyuxu.com/image-20250506234103468.png)

   同本地验证，在ubuntu下创建hello.cu文件，执行编译命令`nvcc ./hello.cu -o hello`

   ![image-20250506234342283](https://img.geyuxu.com/image-20250506234342283.png)

   ![image-20250506234751954](https://img.geyuxu.com/image-20250506234751954.png)
