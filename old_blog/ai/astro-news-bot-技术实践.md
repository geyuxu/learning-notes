...
pubDate: 2025-07-25 14:30:45
description: "基于 AI 和 GitOps 理念，从零到一构建自动化科技新闻聚合系统，实现多源抓取、向量去重、智能摘要与 Astro 博客无缝集成的完整技术实践。"
series: "AI工程实践"
series_no: 1
---
...
于是我决定自己动手，打造一个完全属于我的 AI 新闻情报官——`astro-news-bot`。这不只是一个简单的爬虫脚本，而是一个**端到端、全自动、基于 AI 的新闻处理与发布管道**，最终将精选内容无缝发布到我基于 Astro 构建的个人博客 [geyuxu.com](https://geyuxu.com) 上。
