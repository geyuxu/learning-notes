...
pubDate: 2025-07-23
description: "一个使用Swift和SwiftUI构建的完整macOS学生管理系统，采用MVVM架构和DAO设计模式，实现学生、教师、课程、选课和考试成绩的全方位管理。"
---

## 项目概览

StudentCRUD是一个基于Swift和SwiftUI开发的原生macOS桌面应用程序，专门用于教育管理场景。该项目采用现代化的MVVM（Model-View-ViewModel）架构和DAO（Data Access Object）设计模式，提供了完整的学生信息管理系统功能。
