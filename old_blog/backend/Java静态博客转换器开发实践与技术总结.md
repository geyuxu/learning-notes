...
description: "基于Java 8和Maven构建的Markdown转HTML静态博客生成器，支持多种文档格式、模板引擎和安全设计"
pubDate: 2025-07-22
...
今天完成了一个基于 **Java 8** 和 **Maven** 的静态博客转换器项目开发，该工具能够将 Markdown 文件转换为静态 HTML 博客网站，支持多种文档格式处理和模板化配置。
