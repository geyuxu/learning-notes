...
description: "A Markdown-to-HTML static blog generator based on Java 8 and Maven, supporting multiple document formats, template engine, and security design"
pubDate: 2025-07-22
...
Today completed the development of a static blog converter project based on **Java 8** and **Maven**. This tool can convert Markdown files to static HTML blog websites, supporting multiple document format processing and template-based configuration.
