...
pubDate: '2025-07-25 05:35:00'
description: '在将 Astro 博客部署到 GitHub Pages 后遇到 CSS 文件 404 问题的完整调试过程，从错误假设到最终定位 GitHub Pages 不允许访问下划线开头文件的真实原因。'
---
...
打开浏览器开发者工具，`Console` 和 `Network` 面板清晰地揭示了问题所在：所有的 CSS 文件请求都返回了 `404 Not Found`。
