...
description: 'A complete debugging journey documenting how I solved CSS file 404 errors when deploying an Astro blog to GitHub Pages, from false assumptions to discovering the real cause: GitHub Pages blocking underscore-prefixed files.'
---
