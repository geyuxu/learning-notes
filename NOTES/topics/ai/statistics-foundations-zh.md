...
![典型的原始显微图：成千上万的蛋白质颗粒被埋在随机噪声的海洋中。](/ASSETS/2025-05-27-133802HS2DtK.png)

为了重构结构，图像被对齐然后平均。因为每个图像中的噪声是随机和独立的，它在平均过程中相互抵消。然而，蛋白质的微弱潜在信号是一致的，并在平均中得到强化。

![对齐后的 2D 类别平均。微弱的颗粒，当平均后，显示出清晰的环状结构。](/ASSETS/2025-05-27-134144UY3L1Y.png)
...
![Cryo-EM 工作流程：对齐 → 平均 → 迭代 → 重构 3D 图。](/ASSETS/2025-05-27-134219I9Pul9.png)

结果是分子的高分辨率 3D 图，这一成就因统计学平均的基本原理而成为可能。

![最终 3D 重构的切片，密度按强度着色。](/ASSETS/2025-05-27-134257qN7BvW.png)
...
![接吻研究的模拟结果](/ASSETS/2025-05-27-141307jig87U.png)
