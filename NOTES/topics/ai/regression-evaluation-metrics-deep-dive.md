...
Last updated: 2025-07-26 18:33:35
Tags: ["Machine Learning", "Data Science", "Regression", "Python"]
TL;DR:
- Migrated from old blog.
- Original title: 回归模型评估指标深度解析：从MAE到R²，选对指标才能优化模型
- See notebook for details.

在构建回归模型时，我们不仅要让模型“跑起来”，更关键的是要准确评估其表现。一个好的评估指标能告诉我们模型预测的准确度、鲁棒性以及是否抓住了数据的核心规律。然而，面对 MAE、MSE、R² 等众多指标，我们该如何选择？

本文将带你深入浅出地梳理回归任务中最核心的评估指标。我们将从核心概念回顾开始，补充常用但易被忽视的指标，剖析各自的优缺点与适用场景，并最终通过一个 `scikit-learn` 实战示例，让你能够轻松地在项目中应用这些知识。

### 1. 核心概念回顾

首先，我们回顾一下几个最基础、最核心的回归指标。
